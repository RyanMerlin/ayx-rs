...
const CATALOG_METADATA: &[CatalogMetadata] = &[
    ...
    CatalogMetadata {
        ...
        notes: &["Numeric workspace id, not the GID."],
    },
    CatalogMetadata {
        path: "one/workspace/use",
        output: "one workspace use envelope",
        safety: "mutating",
        mutating: true,
        prerequisites: &["central runtime profile", "stored workspace credentials"],
        notes: &[
            "Verifies the selected credential against the current-workspace endpoint before persisting active state.",
        ],
    },
    CatalogMetadata {
        path: "one/workspace/config/get",
        output: "workspace configuration envelope",
        safety: "read-only",
        mutating: false,
        prerequisites: &["central runtime profile", "alteryx_one.access_token"],
        notes: &["Maps to GET /v4/workspaces/current/configuration."],
    },
    CatalogMetadata {
        path: "one/workspace/config/set",
        output: "workspace configuration update envelope",
        safety: "mutating",
        mutating: true,
        prerequisites: &[
            "central runtime profile",
        ...
        notes: &["Maps to PATCH /v4/workspaces/current/configuration."],
    },
    CatalogMetadata {
        path: "one/workspace/config/schema",
        output: "workspace configuration schema envelope",
        safety: "read-only",
        mutating: false,
        prerequisites: &["central runtime profile", "alteryx_one.access_token"],
        notes: &["Maps to GET /v4/workspaces/current/configuration-schema."],
    },
    CatalogMetadata {
        path: "one/workspace/config/reset",
        output: "workspace configuration reset envelope",
        safety: "mutating",
        mutating: true,
        prerequisites: &["central runtime profile", "alteryx_one.access_token"],
        notes: &["Maps to POST /v4/workspaces/current/delete-configuration."],
    },
    CatalogMetadata {
        path: "one/workspace/members/list",
        output: "workspace members envelope",
        safety: "read-only",
        mutating: false,
        prerequisites: &["central runtime profile", "alteryx_one.access_token"],
        notes: &["Maps to GET /v4/people; workspace context is conveyed by the workspace header."],
    },
    CatalogMetadata {
        path: "one/workspace/members/admins",
        output: "workspace admins envelope",
        safety: "read-only",
        mutating: false,
        prerequisites: &["central runtime profile", "alteryx_one.access_token"],
        notes: &[
            "Maps to GET /v4/workspaces/{workspaceId}/admins using the resolved numeric workspace ID.",
        ],
    },
    CatalogMetadata {
        path: "one/workspace/members/invite",
        output: "workspace member invite envelope",
        safety: "mutating",
        mutating: true,
        prerequisites: &[
            "central runtime profile",
        ...
        notes: &["Maps to POST /v4/workspaces/{id}/people."],
    },
    CatalogMetadata {
        path: "one/workspace/members/reinvite",
        output: "workspace member reinvite envelope",
        safety: "mutating",
        mutating: true,
        prerequisites: &[
            "central runtime profile",
        ...
        notes: &["Maps to PATCH /v4/workspaces/{id}/people/batch."],
    },
    CatalogMetadata {
        path: "one/workspace/members/remove",
        output: "workspace member removal envelope",
        safety: "mutating",
        mutating: true,
        prerequisites: &["central runtime profile", "alteryx_one.access_token"],
        notes: &["Maps to DELETE /v4/workspaces/{workspaceId}/people/{id}."],
    },
    CatalogMetadata {
        path: "one/workspace/members/suspend",
        output: "workspace member suspend envelope",
        safety: "mutating",
        mutating: true,
        prerequisites: &["central runtime profile", "alteryx_one.access_token"],
        notes: &["Maps to PUT /v4/workspaces/{id}/people/{personId}/suspended."],
    },
    CatalogMetadata {
        path: "one/workspace/members/unsuspend",
        output: "workspace members unsuspend envelope",
        safety: "mutating",
        mutating: true,
        prerequisites: &["central runtime profile", "alteryx_one.access_token"],
        notes: &["Maps to POST /v4/workspaces/{id}/people/unsuspend; vendor semantics are bulk."],
    },
    CatalogMetadata {
        path: "one/workspace/members/update",
        output: "workspace member update envelope",
        safety: "mutating",
        mutating: true,
        prerequisites: &[
            "central runtime profile",
        ...
        notes: &[
            "Maps to PATCH /v4/workspaces/{workspaceId}/people/{id}; the destructive PUT variant is intentionally not exposed.",
        ],
    },
    CatalogMetadata {
        path: "one/workspace/members/invitation-link",
        output: "workspace invitation link envelope",
        safety: "read-only",
        mutating: false,
        prerequisites: &["central runtime profile", "alteryx_one.access_token"],
        notes: &["Maps to GET /v4/workspaces/{id}/invitationLink?personId={personId}."],
    },
    CatalogMetadata {
        path: "one/workspace/groups/list",
        output: "workspace groups envelope",
        safety: "read-only",
        mutating: false,
        prerequisites: &["central runtime profile", "alteryx_one.access_token"],
        notes: &["Maps to GET /v4/workspaces/{id}/groups."],
    },
    CatalogMetadata {
        path: "one/workspace/groups/create",
        output: "workspace group create envelope",
        safety: "mutating",
        mutating: true,
        prerequisites: &[
            "central runtime profile",
        ...
        notes: &["Maps to POST /v4/workspaces/{id}/groups."],
    },
    CatalogMetadata {
        path: "one/workspace/groups/update",
        output: "workspace group update envelope",
        safety: "mutating",
        mutating: true,
        prerequisites: &[
            "central runtime profile",
        ...
        notes: &["Maps to PUT /v4/workspaces/{id}/groups/{groupId}."],
    },
    CatalogMetadata {
        path: "one/workspace/groups/delete",
        output: "workspace group delete envelope",
        safety: "mutating",
        mutating: true,
        prerequisites: &["central runtime profile", "alteryx_one.access_token"],
        notes: &["Maps to DELETE /v4/workspaces/{id}/groups/{groupId}."],
    },
    CatalogMetadata {
        path: "one/workspace/groups/members/add",
        output: "workspace group member add envelope",
        safety: "mutating",
        mutating: true,
        prerequisites: &[
            "central runtime profile",
        ...
        notes: &["Maps to POST /v4/workspaces/{id}/groups/{groupId}/users with repeated userIds."],
    },
    CatalogMetadata {
        path: "one/workspace/groups/members/remove",
        output: "workspace group member removal envelope",
        safety: "mutating",
        mutating: true,
        prerequisites: &[
            "central runtime profile",
        ...
        notes: &[
            "Maps to DELETE /v4/workspaces/{id}/groups/{groupId}/users with repeated userIds.",
        ],
    },
    CatalogMetadata {
        path: "one/workspace/groups/roles/set",
        output: "workspace group role update envelope",
        safety: "mutating",
        mutating: true,
        prerequisites: &[
            "central runtime profile",
        ...
        notes: &["Maps to PUT /v4/workspaces/{id}/groups/{groupId}/roles."],
    },
    CatalogMetadata {
        path: "one/workspace/cloud-configs/list",
        output: "workspace cloud configurations envelope",
        safety: "read-only",
        mutating: false,
        prerequisites: &["central runtime profile", "alteryx_one.access_token"],
        notes: &["Maps to GET /v4/workspaces/{workspaceId}/cloudConfigs."],
    },
    CatalogMetadata {
        path: "one/workspace/cloud-configs/create",
        output: "workspace cloud configuration create envelope",
        safety: "mutating",
        mutating: true,
        prerequisites: &[
            "central runtime profile",
        ...
        notes: &["Maps to POST /v4/workspaces/{workspaceId}/cloudConfigs/{cloudProvider}."],
    },
    CatalogMetadata {
        path: "one/workspace/cloud-configs/update",
        output: "workspace cloud configuration update envelope",
        safety: "mutating",
        mutating: true,
        prerequisites: &[
            "central runtime profile",
        ...
        notes: &["Maps to PATCH /v4/workspaces/{workspaceId}/cloudConfigs/{cloudProvider}."],
    },
    CatalogMetadata {
        path: "one/workspace/transfer/start",
        output: "workspace transfer envelope",
        safety: "mutating",
        mutating: true,
        prerequisites: &["central runtime profile", "alteryx_one.access_token"],
        notes: &["Maps to PATCH /v4/workspaces/{id}/transfer."],
    },
    CatalogMetadata {
        path: "one/workspace/transfer/assets",
        output: "workspace asset transfer envelope",
        safety: "mutating",
        mutating: true,
        prerequisites: &[
            "central runtime profile",
        ...
        notes: &["Maps to PATCH /v4/workspaces/current/transfer."],
    },
    CatalogMetadata {
    ...
    CatalogMetadata {
        ...
        prerequisites: &["central runtime profile", "alteryx one credential"],
        notes: &[
            "Provider-contract gated: POST /v4/plans/package is not live-verified and the package input mechanism is undocumented; the CLI performs no network call until this is resolved.",
        ],
    },
    CatalogMetadata {
    ...
    CatalogMetadata {
        path: "one/jobs/count",
        output: "one jobs count envelope",
        safety: "read-only",
        mutating: false,
        prerequisites: &["central runtime profile", "alteryx one credential"],
    ...
    CatalogMetadata {
        path: "one/jobs/pdf-results",
        output: "one jobs pdf-results envelope",
        safety: "read-only",
        mutating: false,
        prerequisites: &["central runtime profile", "alteryx one credential"],
    ...
    CatalogMetadata {
        path: "one/jobs/execute",
        output: "one jobs execute envelope",
        safety: "mutating",
        mutating: true,
        prerequisites: &[
            "central runtime profile",
    ...
    CatalogMetadata {
        path: "one/jobs/publish",
        output: "one jobs publish envelope",
        safety: "mutating",
        mutating: true,
        prerequisites: &[
            "central runtime profile",
    ...
    CatalogMetadata {
        path: "one/jobs",
        output: "one jobs aggregate detail envelope",
        safety: "read-only",
        mutating: false,
        prerequisites: &["central runtime profile", "alteryx one credential"],
    ...
    CatalogMetadata {
        path: "one/jobs/cancel",
        output: "one jobs cancel envelope",
        safety: "mutating",
        mutating: true,
        prerequisites: &["central runtime profile", "alteryx one credential"],
    ...
    CatalogMetadata {
        path: "one/jobs/status",
        output: "one jobs status envelope",
        safety: "read-only",
        mutating: false,
        prerequisites: &["central runtime profile", "alteryx one credential"],
    ...
    CatalogMetadata {
        path: "one/jobs/inputs",
        output: "one jobs inputs envelope",
        safety: "read-only",
        mutating: false,
        prerequisites: &["central runtime profile", "alteryx one credential"],
    ...
    CatalogMetadata {
        path: "one/jobs/outputs",
        output: "one jobs outputs envelope",
        safety: "read-only",
        mutating: false,
        prerequisites: &["central runtime profile", "alteryx one credential"],
    ...
    CatalogMetadata {
        path: "one/jobs/publications",
        output: "one jobs publications envelope",
        safety: "read-only",
        mutating: false,
        prerequisites: &["central runtime profile", "alteryx one credential"],
    ...
    CatalogMetadata {
        path: "one/jobs/profile",
        output: "one jobs profile envelope",
        safety: "read-only",
        mutating: false,
        prerequisites: &["central runtime profile", "alteryx one credential"],
    ...
    CatalogMetadata {
        path: "one/jobs/profile-results",
        output: "one jobs profile-results envelope",
        safety: "read-only",
        mutating: false,
        prerequisites: &["central runtime profile", "alteryx one credential"],
    ...
    CatalogMetadata {
        ...
        notes: &[
            ...
            "Workflow graph inspection preserves raw provider data and adds normalized node, configuration, port, and connection buckets.",
        ],
    },
    CatalogMetadata {
    ...
    CatalogMetadata {
        path: "one/workflows/graph",
        output: "one workflows graph envelope",
        safety: "read-only",
        mutating: false,
        prerequisites: &["central runtime profile", "alteryx one credential"],
        notes: &[
            "Synthesized from the verified workflow asset listing; raw provider data remains in data.response.",
            "Field-level schemas are reported only when the provider includes one; the CLI does not infer schemas.",
        ],
    },
    CatalogMetadata {
