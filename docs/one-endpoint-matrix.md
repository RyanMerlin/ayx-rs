...
| GET | `/v4/jobGroups/{id}/jobs` | live 200 | 2026-07-27T00:55Z | `one jobs runs` | object: raw API resource body, JSON-passthrough | json:ApiValidationFailed / json:RouteNotFoundException / json:AccessControlException (Alteryx One `/v4` gateway shape) | Child run collection for an aggregate job returned 200. |
