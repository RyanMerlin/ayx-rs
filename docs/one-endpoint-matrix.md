...
| Method | Path | Live status | Verified (UTC) | ayx command(s) | Response shape | Error-body flavor | Notes |
|---|---|---|---|---|---|---|---|
| GET | `/v4/open-api-spec` | live 200 | 2026-08-14T16:14Z | `one api coverage`<br>`one api open-api-spec` | object: raw API resource body, JSON-passthrough | json:ApiValidationFailed / json:RouteNotFoundException / json:AccessControlException (Alteryx One `/v4` gateway shape) | Phase 2 returned a populated spec; Phase 3 coverage reported `coverage_pct: 43.8`, `inventory_total: 150`, `spec_operations: 235`, and 25 `outside_spec_namespace` rows. `stale[].commands` is an array. |
...
| Method | Path | Live status | Verified (UTC) | ayx command(s) | Response shape | Error-body flavor | Notes |
|---|---|---|---|---|---|---|---|
| GET | `/v4/plans` | unverified | not probed since repoint | `one plans list` | paginated list: `{ items[], next_page_token, pages_fetched, page_envelopes[] }` (CLI-normalized) | json:ApiValidationFailed / json:RouteNotFoundException / json:AccessControlException (Alteryx One `/v4` gateway shape) | Repointed from `/plans/v1/plans` (in no spec, live 404 RouteNotFoundException) to the spec-documented path. Not yet re-probed live. |
| GET | `/v4/plans/{id}/full` | unverified | not probed since repoint | `one plans detail`<br>`one plans full` | object: raw API resource body, JSON-passthrough | json:ApiValidationFailed / json:RouteNotFoundException / json:AccessControlException (Alteryx One `/v4` gateway shape) | Repointed from `/plans/v1/plans/{id}` (in no spec, live 404 RouteNotFoundException) to the spec-documented path. Not yet re-probed live. |
...
| GET | `/v4/plans/count` | unverified | not probed since repoint | `one plans count` | object: raw API count body (`{ count }`/`{ total }`, service-specific) | json:ApiValidationFailed / json:RouteNotFoundException / json:AccessControlException (Alteryx One `/v4` gateway shape) | Repointed from `/plans/v1/plans/count` (in no spec, live 404 RouteNotFoundException) to the spec-documented path. Not yet re-probed live. |
| GET | `/v4/plans/{id}/runParameters` | unverified | not probed since repoint | `one plans run-parameters` | object: raw API resource body, JSON-passthrough | json:ApiValidationFailed / json:RouteNotFoundException / json:AccessControlException (Alteryx One `/v4` gateway shape) | Repointed from `/plans/v1/plans/{id}/runParameters` (in no spec, live 404 RouteNotFoundException) to the spec-documented path. Not yet re-probed live. |
| GET | `/v4/plans/{id}/schedules` | unverified | not probed since repoint | `one plans schedules` | paginated list: `{ items[], next_page_token, pages_fetched, page_envelopes[] }` (CLI-normalized) | json:ApiValidationFailed / json:RouteNotFoundException / json:AccessControlException (Alteryx One `/v4` gateway shape) | Repointed from `/plans/v1/plans/{id}/schedules` (in no spec, live 404 RouteNotFoundException) to the spec-documented path. Not yet re-probed live. |
| GET | `/v4/plans/{id}/package` | unverified | not probed since repoint | `one plans export` | object: raw API resource body, JSON-passthrough | json:ApiValidationFailed / json:RouteNotFoundException / json:AccessControlException (Alteryx One `/v4` gateway shape) | Repointed from `/plans/v1/plans/{id}/package` (in no spec, live 404 RouteNotFoundException) to the spec-documented path. Not yet re-probed live. |
...
| GET | `/v4/plans/{id}/permissions` | unverified | not probed since repoint | `one plans permissions` | object: raw API resource body, JSON-passthrough | json:ApiValidationFailed / json:RouteNotFoundException / json:AccessControlException (Alteryx One `/v4` gateway shape) | Repointed from `/plans/v1/plans/{id}/permissions` (in no spec, live 404 RouteNotFoundException) to the spec-documented path. Not yet re-probed live. |
...
| Method | Path | Live status | Verified (UTC) | ayx command(s) | Response shape | Error-body flavor | Notes |
|---|---|---|---|---|---|---|---|
| GET | `/v4/schedules` | unverified | not probed since repoint | `one scheduling list` | paginated list: `{ items[], next_page_token, pages_fetched, page_envelopes[] }` (CLI-normalized) | json:ApiValidationFailed / json:RouteNotFoundException / json:AccessControlException (Alteryx One `/v4` gateway shape) | Repointed from `/scheduling/v1/schedules` (in no spec, live 404 RouteNotFoundException) to the spec-documented path. Not yet re-probed live. |
| GET | `/v4/schedules/{id}` | unverified | not probed since repoint | `one scheduling detail` | object: raw API resource body, JSON-passthrough | json:ApiValidationFailed / json:RouteNotFoundException / json:AccessControlException (Alteryx One `/v4` gateway shape) | Repointed from `/scheduling/v1/schedules/{id}` (in no spec, live 404 RouteNotFoundException) to the spec-documented path. Not yet re-probed live. |
...
| Method | Path | Live status | Verified (UTC) | ayx command(s) | Response shape | Error-body flavor | Notes |
|---|---|---|---|---|---|---|---|
| GET | `/v4/datasetLibrary` | live 400 ApiValidationFailed — CLI wiring gap | 2026-08-14T16:09Z | `one datasets list` | paginated list: `{ items[], next_page_token, pages_fetched, page_envelopes[] }` (CLI-normalized) | json:ApiValidationFailed / json:RouteNotFoundException / json:AccessControlException (Alteryx One `/v4` gateway shape) | Phase 2 reconfirmed 400 `ApiValidationFailed`: `datasetsFilter` must not be null. The route exists, but this CLI leaf still omits the required filter. |
